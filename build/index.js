...
const resolvers = {
  Query: {
    ...
    user: (parent, {
      id,
      name
    }) => users.find(user => user.id == id && (name ? user.name == name : true))
  },
  Mutation: {
    createUser: (parent, {
      id,
